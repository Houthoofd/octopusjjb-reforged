...
})({"9u4JN":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "f47d8f6bd4d98789";
"use strict";
...
var _inscription = require("./pages/inscription");

},{"./navigation":"f8xTW","./pages/main-application":"2wB5l","./pages/inscription":"bvryy"}],"f8xTW":[function(require,module,exports) {
    ...
    (0, _core.customElement)({
      ...
      <div id="inscription">
        ...
        <div class="navigation">
          <button @click="${()=>inscription.goToStep(inscription.currentStep - 1)}" ?disabled="${inscription.currentStep === 1}">
            Précédent
          </button>
          <button @click="${()=>inscription.goToStep(inscription.currentStep + 1)}" ?disabled="${inscription.currentStep === 3}">
            Suivant
          </button>
        </div>
      </div>
...
},{"@swc/helpers/_/_ts_decorate":"lX6TJ","@lithium-framework/core":"hmv1B","@lithium-framework/router-element":"cZ2Eg","unofficial-pf-v5-wc":"bU1uI","unofficial-pf-v5-wc-icons":"7gm82","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["9u4JN"], null, "parcelRequire1c26")

//# sourceMappingURL=index.d4d98789.js.map
