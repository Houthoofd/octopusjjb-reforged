...
})({"b2uzu":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "18d61602523f1d9a";
"use strict";
...
},{}],"juXnI":[function(require,module,exports) {
...
class Notifications extends (0, _core.WebComponent) {
}
Notifications = (0, _tsDecorate._)([
    (0, _core.customElement)({
        name: "page-notifications",
        template: (0, _core.html)`${(notifications)=>{
            return (0, _core.html)`
       <div id="application">
            <div class="header">
...
(0, _core.render)((0, _core.html)`<page-notifications></page-notifications>`, document.body);
...
},{"@swc/helpers/_/_ts_decorate":"lX6TJ","@lithium-framework/core":"hmv1B","@lithium-framework/router-element":"cZ2Eg","unofficial-pf-v5-wc":"bU1uI","unofficial-pf-v5-wc-icons":"7gm82","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["b2uzu","juXnI"], "juXnI", "parcelRequire1c26")

//# sourceMappingURL=index.523f1d9a.js.map
