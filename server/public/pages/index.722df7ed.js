var t=globalThis,e={},i={},s=t.parcelRequire1c26;null==s&&((s=function(t){if(t in e)return e[t].exports;if(t in i){var s=i[t];delete i[t];var a={id:t,exports:{}};return e[t]=a,s.call(a.exports,a,a.exports),a.exports}var l=Error("Cannot find module '"+t+"'");throw l.code="MODULE_NOT_FOUND",l}).register=function(t,e){i[t]=e},t.parcelRequire1c26=s);var a=s.register;a("7KTRf",function(t,e){s("jcBBX")}),a("jcBBX",function(t,e){s("l8jY8"),s("fw7Hj"),s("kyBce"),s("2QNEa"),s("hypTO"),s("2ByoK")}),a("l8jY8",function(t,e){s("hypTO")}),a("hypTO",function(t,e){var i=s("7WQrb"),a=s("5D1XK");s("RKbfs"),s("3I5Zu"),s("dLLJA");class l extends a.WebComponent{connectedCallback(){super.connectedCallback(),console.log("VerticalNavBar connecté"),this.open=this.isOpen?"true":"false",document.addEventListener("close-navbars",this.handleCloseNavbars.bind(this))}handleCloseNavbars(t){console.log("L'événement close-navbars a été détecté.",t);let e=this.shadowRoot?.querySelectorAll("#sidebar")[0],i=this.shadowRoot?.querySelectorAll("a"),s=this.shadowRoot?.querySelectorAll("ul")[0];i.forEach(t=>{t.classList.toggle("close")}),s.classList.toggle("close"),e.classList.toggle("close"),this.open="false",this.renderNavBar()}attributeChangedCallback(t,e,i){"isopen"===t&&(console.log(`Attribut isOpen modifi\xe9 de ${e} \xe0 ${i}`),this.open=i?"true":"false",this.renderNavBar())}renderNavBar(){console.log("Rendu de la barre de navigation avec open =",this.open)}constructor(...t){super(...t),this.open=null,this.isOpen=!0}}(0,i.__decorate)([(0,a.state)()],l.prototype,"open",void 0),(0,i.__decorate)([(0,a.attr)()],l.prototype,"isOpen",void 0),(0,i.__decorate)([(0,a.customElement)({name:"vertical-navbar",template:(0,a.html)`${t=>(0,a.html)`
        <nav id="sidebar">
         <ul id="top-sidebar">
            <li>
               <a href="/pages/">
      ...
      `]})],l)}),a("fw7Hj",function(t,e){s("2ByoK")}),a("2ByoK",function(t,e){var i=s("7WQrb"),a=s("5D1XK");s("RKbfs"),s("3I5Zu"),s("dLLJA");class l extends a.WebComponent{closeVerticalNavBar(t){let e=this.shadowRoot?.querySelectorAll("button")?.[0];(this.shadowRoot?.querySelectorAll("#sidebar")?.[0]).classList.toggle("close"),e.classList.toggle("close");let i=new CustomEvent("close-navbars",{bubbles:!0,composed:!0,detail:{message:"Close all external navbars"}});this.dispatchEvent(i)}openVerticalNavBar(){}constructor(...t){super(...t),this.open=null,this.isOpen=null}}(0,i.__decorate)([(0,a.state)()],l.prototype,"open",void 0),(0,i.__decorate)([(0,a.attr)()],l.prototype,"isOpen",void 0),(0,i.__decorate)([(0,a.customElement)({name:"horizontal-navbar",template:(0,a.html)`${t=>(0,a.html)`
        <nav id="sidebar">
      ...
      `]})],l)}),a("kyBce",function(t,e){s("2QNEa")}),a("2QNEa",function(t,e){var i=s("7WQrb"),a=s("5D1XK");s("RKbfs"),s("3I5Zu"),s("dLLJA");class l extends a.WebComponent{}(0,i.__decorate)([(0,a.customElement)({name:"vertical-horizontal-navbar",template:(0,a.html)`${t=>(0,a.html)`
        <nav id="sidebar">
         <ul id="top-sidebar">
            <li>
               <a href="/pages/">
      ...
      `]})],l)});
//# sourceMappingURL=index.722df7ed.js.map
