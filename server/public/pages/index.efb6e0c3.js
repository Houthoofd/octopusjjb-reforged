var e=globalThis,t={},i={},s=e.parcelRequire1c26;null==s&&((s=function(e){if(e in t)return t[e].exports;if(e in i){var s=i[e];delete i[e];var o={id:e,exports:{}};return t[e]=o,s.call(o.exports,o,o.exports),o.exports}var a=Error("Cannot find module '"+e+"'");throw a.code="MODULE_NOT_FOUND",a}).register=function(e,t){i[e]=t},e.parcelRequire1c26=s);var o=s.register;o("7KTRf",function(e,t){s("jcBBX"),s("b8ikq")}),o("jcBBX",function(e,t){s("l8jY8"),s("fw7Hj"),s("b8ikq"),s("3tWFl"),s("hypTO"),s("2ByoK")}),o("l8jY8",function(e,t){s("hypTO")}),o("hypTO",function(e,t){var i=s("7WQrb"),o=s("5D1XK");s("RKbfs"),s("3I5Zu"),s("dLLJA");class a extends o.WebComponent{connectedCallback(){super.connectedCallback(),console.log("vertical navbar connecté"),this.onMounting(),document.addEventListener("close-navbars",this.handleCloseNavbars.bind(this)),document.addEventListener("open-navbars",this.handleOpenNavbars.bind(this)),document.addEventListener("dark-mode",this.handleMode.bind(this)),document.addEventListener("light-mode",this.handleMode.bind(this))}onMounting(){let e=JSON.parse(localStorage.getItem("navigation"));!1===e.horizontal_vertical_state?this.Minimize():!0===e.horizontal_vertical_state&&this.Expand(),console.log(e.dark_mode),!1===e.dark_mode?this.lightMode():!0===e.dark&&this.darkMode()}handleMode(e){let t=JSON.parse(localStorage.getItem("navigation"))||{};!0===e.detail.dark_mode&&!1===this.isDark?(this.isDark=!0,this.darkMode(),t.dark_mode=this.isDark,localStorage.setItem("navigation",JSON.stringify(t))):!1===e.detail.dark_mode&&!0===this.isDark&&(this.isDark=!1,this.lightMode(),t.dark_mode=this.isDark,localStorage.setItem("navigation",JSON.stringify(t)))}darkMode(){let e=this.shadowRoot?.querySelector("#sidebar"),t=this.shadowRoot?.querySelectorAll("a"),i=this.shadowRoot?.querySelectorAll("svg");e&&e.classList.remove("light"),t.forEach(e=>{e.classList.remove("light"),e.parentElement&&e.parentElement.classList.remove("light")}),i.forEach(e=>e.classList.remove("light"))}lightMode(){let e=this.shadowRoot?.querySelector("#sidebar"),t=this.shadowRoot?.querySelectorAll("a"),i=this.shadowRoot?.querySelectorAll("svg");e&&e.classList.toggle("light"),t.forEach(e=>{e.classList.toggle("light"),e.parentElement&&e.parentElement.classList.toggle("light")}),i.forEach(e=>e.classList.toggle("light"))}handleCloseNavbars(e){let t=JSON.parse(localStorage.getItem("navigation"))||{};!0===this.isOpen&&(this.isOpen=!1,this.open="false"),!1===e.detail.horizontalstate&&!1===this.isOpen&&(t.horizontal_vertical_state=this.isOpen,localStorage.setItem("navigation",JSON.stringify(t)),this.Minimize())}handleOpenNavbars(e){let t=JSON.parse(localStorage.getItem("navigation"))||{};!1===this.isOpen&&(this.isOpen=!0,this.open="true"),!0===e.detail.horizontalstate&&!0===this.isOpen&&(t.horizontal_vertical_state=this.isOpen,localStorage.setItem("navigation",JSON.stringify(t)),this.Expand())}Minimize(){let e=this.shadowRoot?.querySelectorAll("#sidebar")[0];(this.shadowRoot?.querySelectorAll("a")).forEach(e=>{e.classList.toggle("close"),e.parentElement.classList.toggle("close")}),e.classList.toggle("close")}Expand(){let e=this.shadowRoot?.querySelectorAll("#sidebar")[0];(this.shadowRoot?.querySelectorAll("a")).forEach(e=>{e.classList.remove("close"),e.parentElement.classList.remove("close")}),e.classList.remove("close")}attributeChangedCallback(e,t,i){"isopen"===e&&(this.open=i),super.attributeChangedCallback(e,t,i)}switchMode(){let e=this.shadowRoot?.querySelectorAll("#sidebar")[0];(this.shadowRoot?.querySelectorAll("a")).forEach(e=>{e.classList.remove("close"),e.parentElement.classList.remove("close")}),e.classList.remove("close")}constructor(...e){super(...e),this.isOpen=!0,this.isDark=!0,this.open=null,this.dark=null}}(0,i.__decorate)([(0,o.state)()],a.prototype,"isOpen",void 0),(0,i.__decorate)([(0,o.state)()],a.prototype,"isDark",void 0),(0,i.__decorate)([(0,o.attr)()],a.prototype,"open",void 0),(0,i.__decorate)([(0,o.attr)()],a.prototype,"dark",void 0),(0,i.__decorate)([(0,o.customElement)({name:"vertical-navbar",template:(0,o.html)`${e=>(0,o.html)`
        <nav id="sidebar">
         <ul id="top-sidebar">
            <li>
               <a href="/pages/">
      ...
      `]})],a)}),o("b8ikq",function(e,t){s("3tWFl")}),o("3tWFl",function(e,t){var i=s("7WQrb"),o=s("5D1XK");s("RKbfs"),s("3I5Zu"),s("dLLJA"),s("jcBBX");class a extends o.WebComponent{connectedCallback(){super.connectedCallback(),console.log("main-application connecté"),this.onMounting(),document.addEventListener("close-navbars",this.handleRemoveExpanseContent.bind(this)),document.addEventListener("open-navbars",this.handleExpanseContent.bind(this)),document.addEventListener("dark-mode",this.handleMode.bind(this)),document.addEventListener("light-mode",this.handleMode.bind(this))}onMounting(){let e=JSON.parse(localStorage.getItem("navigation"));!1===e.horizontal_vertical_state?this.Expand():!0===e.horizontal_vertical_state&&this.Minimize(),console.log(e.dark_mode),!1===e.dark_mode?this.lightMode():!0===e.dark&&this.darkMode()}handleMode(e){let t=JSON.parse(localStorage.getItem("navigation"))||{};console.log(e.detail.dark_mode,t.dark_mode),!0===e.detail.dark_mode&&!0===t.dark_mode?(this.isDark=!0,this.darkMode()):!1===e.detail.dark_mode&&!1===t.dark_mode&&(this.isDark=!1,this.lightMode())}darkMode(){(this.shadowRoot?.querySelectorAll(".right-content")[0]).classList.remove("expand")}lightMode(){(this.shadowRoot?.querySelectorAll(".right-content")[0]).classList.toggle("light")}handleRemoveExpanseContent(e){e.detail?.horizontalstate===!1&&(this.isExpanse=!1,this.expanse="false",this.Expand())}handleExpanseContent(e){e.detail?.horizontalstate===!0&&(this.isExpanse=!0,this.expanse="true",this.Minimize())}Expand(){(this.shadowRoot?.querySelectorAll(".right-content")[0]).classList.toggle("expand")}Minimize(){(this.shadowRoot?.querySelectorAll(".right-content")[0]).classList.remove("expand")}attributeChangedCallback(e,t,i){"expanse"===e&&(this.expanse=i),super.attributeChangedCallback(e,t,i)}constructor(...e){super(...e),this.isExpanse=!0,this.isDark=!0,this.expanse=null,this.dark=null}}(0,i.__decorate)([(0,o.state)()],a.prototype,"isExpanse",void 0),(0,i.__decorate)([(0,o.state)()],a.prototype,"isDark",void 0),(0,i.__decorate)([(0,o.attr)()],a.prototype,"expanse",void 0),(0,i.__decorate)([(0,o.attr)()],a.prototype,"dark",void 0),(0,i.__decorate)([(0,o.customElement)({name:"main-application",template:(0,o.html)`${e=>(0,o.html)`
        <div id="application">
            <div class="header">
      ...
      `]})],a)});
//# sourceMappingURL=index.efb6e0c3.js.map
