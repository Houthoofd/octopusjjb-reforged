var e=globalThis,t={},i={},s=e.parcelRequire1c26;null==s&&((s=function(e){if(e in t)return t[e].exports;if(e in i){var s=i[e];delete i[e];var a={id:e,exports:{}};return t[e]=a,s.call(a.exports,a,a.exports),a.exports}var n=Error("Cannot find module '"+e+"'");throw n.code="MODULE_NOT_FOUND",n}).register=function(e,t){i[e]=t},e.parcelRequire1c26=s);var a=s.register;a("7KTRf",function(e,t){s("jcBBX"),s("b8ikq")}),a("jcBBX",function(e,t){s("l8jY8"),s("fw7Hj"),s("b8ikq"),s("3tWFl"),s("hypTO"),s("2ByoK")}),a("l8jY8",function(e,t){s("hypTO")}),a("hypTO",function(e,t){var i=s("7WQrb"),a=s("5D1XK");s("RKbfs"),s("3I5Zu"),s("dLLJA");class n extends a.WebComponent{connectedCallback(){super.connectedCallback(),console.log("vertical navbar connecté"),document.addEventListener("close-navbars",this.handleCloseNavbars.bind(this)),document.addEventListener("open-navbars",this.handleOpenNavbars.bind(this))}handleCloseNavbars(e){if(console.log("handleCloseNavbars : signal reçu",e.detail.horizontalstate,this.open,this.isOpen),!0===this.isOpen&&(this.isOpen=!1),!1===e.detail.horizontalstate&&!1===this.isOpen){let t={horizontal:e.detail.horizontalstate,vertical:this.isOpen};console.log(t),localStorage.setItem("navigation",JSON.stringify(t))}}handleOpenNavbars(e){if(console.log("handleOpenNavbars : signal reçu",e.detail.horizontalstate,this.open),!1===this.isOpen&&(this.isOpen=!0),!0===e.detail.horizontalstate&&!0===this.isOpen){let e={horizontal_vertical:this.isOpen};console.log(e),localStorage.setItem("navigation",JSON.stringify(e))}}attributeChangedCallback(e,t,i){console.log(`vertical : Changement d'\xe9tat entre ${t} et ${i}`),"isopen"===e&&(this.open=i,console.log(`Etat chang\xe9 entre ${i} et ${this.open}`)),super.attributeChangedCallback(e,t,i)}constructor(...e){super(...e),this.isOpen=!0,this.open=!0}}(0,i.__decorate)([(0,a.state)()],n.prototype,"isOpen",void 0),(0,i.__decorate)([(0,a.attr)()],n.prototype,"open",void 0),(0,i.__decorate)([(0,a.customElement)({name:"vertical-navbar",template:(0,a.html)`${e=>(0,a.html)`
        <nav id="sidebar">
         <ul id="top-sidebar">
            <li>
               <a href="/pages/">
      ...
      `]})],n)});
//# sourceMappingURL=index.7749a61f.js.map
