var t=globalThis,e={},i={},s=t.parcelRequire1c26;null==s&&((s=function(t){if(t in e)return e[t].exports;if(t in i){var s=i[t];delete i[t];var a={id:t,exports:{}};return e[t]=a,s.call(a.exports,a,a.exports),a.exports}var o=Error("Cannot find module '"+t+"'");throw o.code="MODULE_NOT_FOUND",o}).register=function(t,e){i[t]=e},t.parcelRequire1c26=s);var a=s.register;a("7KTRf",function(t,e){s("jcBBX"),s("b8ikq")}),a("jcBBX",function(t,e){s("l8jY8"),s("fw7Hj"),s("b8ikq"),s("3tWFl"),s("hypTO"),s("2ByoK")}),a("l8jY8",function(t,e){s("hypTO")}),a("hypTO",function(t,e){var i=s("7WQrb"),a=s("5D1XK");s("RKbfs"),s("3I5Zu"),s("dLLJA");class o extends a.WebComponent{connectedCallback(){super.connectedCallback(),console.log("vertical navbar connecté"),this.onMounting(),document.addEventListener("close-navbars",this.handleCloseNavbars.bind(this)),document.addEventListener("open-navbars",this.handleOpenNavbars.bind(this))}onMounting(){let t=JSON.parse(localStorage.getItem("navigation"));!1===t.horizontal_vertical_state?this.Minimize():!0===t.horizontal_vertical_state&&this.Expand()}handleCloseNavbars(t){if(!0===this.isOpen&&(this.isOpen=!1,this.open="false"),!1===t.detail.horizontalstate&&!1===this.isOpen){let t={horizontal_vertical_state:this.isOpen};this.Minimize(),localStorage.setItem("navigation",JSON.stringify(t))}}handleOpenNavbars(t){if(!1===this.isOpen&&(this.isOpen=!0,this.open="true"),!0===t.detail.horizontalstate&&!0===this.isOpen){let t={horizontal_vertical_state:this.isOpen};this.Expand(),localStorage.setItem("navigation",JSON.stringify(t))}}Minimize(){let t=this.shadowRoot?.querySelectorAll("#sidebar")[0],e=this.shadowRoot?.querySelectorAll("a"),i=this.shadowRoot?.querySelectorAll("#switch-mode")[0],s=this.shadowRoot?.querySelectorAll(".moon-sun")[0];e.forEach(t=>{t.classList.toggle("close")}),i.classList.toggle("close"),t.classList.toggle("close"),s.classList.toggle("close")}Expand(){let t=this.shadowRoot?.querySelectorAll("#sidebar")[0],e=this.shadowRoot?.querySelectorAll("a"),i=this.shadowRoot?.querySelectorAll("#switch-mode")[0],s=this.shadowRoot?.querySelectorAll(".moon-sun")[0];e.forEach(t=>{t.classList.remove("close")}),i.classList.remove("close"),t.classList.remove("close"),s.classList.remove("close")}attributeChangedCallback(t,e,i){"isopen"===t&&(this.open=i),super.attributeChangedCallback(t,e,i)}constructor(...t){super(...t),this.isOpen=!0,this.open=null}}(0,i.__decorate)([(0,a.state)()],o.prototype,"isOpen",void 0),(0,i.__decorate)([(0,a.attr)()],o.prototype,"open",void 0),(0,i.__decorate)([(0,a.customElement)({name:"vertical-navbar",template:(0,a.html)`${t=>(0,a.html)`
      ...
      `]})],o)});
//# sourceMappingURL=index.7444b8c0.js.map
