var t=globalThis,e={},i={},s=t.parcelRequire1c26;null==s&&((s=function(t){if(t in e)return e[t].exports;if(t in i){var s=i[t];delete i[t];var a={id:t,exports:{}};return e[t]=a,s.call(a.exports,a,a.exports),a.exports}var n=Error("Cannot find module '"+t+"'");throw n.code="MODULE_NOT_FOUND",n}).register=function(t,e){i[t]=e},t.parcelRequire1c26=s);var a=s.register;a("7KTRf",function(t,e){s("jcBBX"),s("b8ikq")}),a("jcBBX",function(t,e){s("l8jY8"),s("fw7Hj"),s("b8ikq"),s("3tWFl"),s("hypTO"),s("2ByoK")}),a("l8jY8",function(t,e){s("hypTO")}),a("hypTO",function(t,e){var i=s("7WQrb"),a=s("5D1XK");s("RKbfs"),s("3I5Zu"),s("dLLJA");class n extends a.WebComponent{connectedCallback(){super.connectedCallback(),console.log("vertical navbar connecté"),this.onMounting(),document.addEventListener("close-navbars",this.handleCloseNavbars.bind(this)),document.addEventListener("open-navbars",this.handleOpenNavbars.bind(this))}onMounting(){let t=JSON.parse(localStorage.getItem("navigation"));!1===t.horizontal_vertical_state?this.Minimize():!0===t.horizontal_vertical_state&&this.Expand()}handleCloseNavbars(t){if(!0===this.isOpen&&(this.isOpen=!1,this.open="false"),!1===t.detail.horizontalstate&&!1===this.isOpen){let t={horizontal_vertical_state:this.isOpen};this.Minimize(),localStorage.setItem("navigation",JSON.stringify(t))}}handleOpenNavbars(t){if(!1===this.isOpen&&(this.isOpen=!0,this.open="true"),!0===t.detail.horizontalstate&&!0===this.isOpen){let t={horizontal_vertical_state:this.isOpen};this.Expand(),localStorage.setItem("navigation",JSON.stringify(t))}}Minimize(){let t=this.shadowRoot?.querySelectorAll("#sidebar")[0];(this.shadowRoot?.querySelectorAll("a")).forEach(t=>{t.classList.toggle("close"),t.parentElement.classList.toggle("close")}),t.classList.toggle("close")}Expand(){let t=this.shadowRoot?.querySelectorAll("#sidebar")[0];(this.shadowRoot?.querySelectorAll("a")).forEach(t=>{t.classList.remove("close"),t.parentElement.classList.remove("close")}),t.classList.remove("close")}attributeChangedCallback(t,e,i){"isopen"===t&&(this.open=i),super.attributeChangedCallback(t,e,i)}switchMode(){console.log("switch mode")}constructor(...t){super(...t),this.isOpen=!0,this.open=null}}(0,i.__decorate)([(0,a.state)()],n.prototype,"isOpen",void 0),(0,i.__decorate)([(0,a.attr)()],n.prototype,"open",void 0),(0,i.__decorate)([(0,a.customElement)({name:"vertical-navbar",template:(0,a.html)`${t=>(0,a.html)`
        <nav id="sidebar">
         <ul id="top-sidebar">
            <li>
               <a href="/pages/">
      ...
      `]})],n)}),a("b8ikq",function(t,e){s("3tWFl")}),a("3tWFl",function(t,e){var i=s("7WQrb"),a=s("5D1XK");s("RKbfs"),s("3I5Zu"),s("dLLJA"),s("jcBBX");class n extends a.WebComponent{connectedCallback(){super.connectedCallback(),console.log("main-application connecté"),this.onMounting(),document.addEventListener("close-navbars",this.handleRemoveExpanseContent.bind(this)),document.addEventListener("open-navbars",this.handleExpanseContent.bind(this))}onMounting(){let t=JSON.parse(localStorage.getItem("navigation"));!1===t.horizontal_vertical_state?this.Expand():!0===t.horizontal_vertical_state&&this.Minimize()}handleRemoveExpanseContent(t){t.detail?.horizontalstate===!1&&(this.isExpanse=!1,this.expanse="false",this.Expand())}handleExpanseContent(t){t.detail?.horizontalstate===!0&&(this.isExpanse=!0,this.expanse="true",this.Minimize())}Expand(){(this.shadowRoot?.querySelectorAll(".right-content")[0]).classList.toggle("expand")}Minimize(){(this.shadowRoot?.querySelectorAll(".right-content")[0]).classList.remove("expand")}attributeChangedCallback(t,e,i){"expanse"===t&&(this.expanse=i),super.attributeChangedCallback(t,e,i)}constructor(...t){super(...t),this.isExpanse=!0,this.expanse=null}}(0,i.__decorate)([(0,a.state)()],n.prototype,"isExpanse",void 0),(0,i.__decorate)([(0,a.attr)()],n.prototype,"expanse",void 0),(0,i.__decorate)([(0,a.customElement)({name:"main-application",template:(0,a.html)`${t=>(0,a.html)`
        <div id="application">
            <div class="header">
      ...
      `]})],n)});
//# sourceMappingURL=index.be98ef0a.js.map
