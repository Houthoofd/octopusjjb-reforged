...
@keyframes spin {
  ...
  100% {
    ...
    `]})],l)}),s("klu2t",function(e,t){a("4UESG"),a("7vBJO")}),s("4UESG",function(e,t){a("7vBJO")}),s("7vBJO",function(e,t){var i=a("7WQrb"),s=a("5D1XK");a("RKbfs"),a("3I5Zu"),a("dLLJA");class o extends s.WebComponent{}(0,i.__decorate)([(0,s.customElement)({name:"modal-popup",template:(0,s.html)`${e=>(0,s.html)`
        <div class="pop-up">
          <slot name="title">
            <span class="title">Inscription Validé</span>
          </slot>
          <div class="content">
            <div class="icon">
              <slot name="icon">
    ...
    `]})],o)});
//# sourceMappingURL=index.34454612.js.map
