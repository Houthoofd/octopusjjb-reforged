var e=globalThis,t={},s={},i=e.parcelRequire1c26;null==i&&((i=function(e){if(e in t)return t[e].exports;if(e in s){var i=s[e];delete s[e];var a={id:e,exports:{}};return t[e]=a,i.call(a.exports,a,a.exports),a.exports}var o=Error("Cannot find module '"+e+"'");throw o.code="MODULE_NOT_FOUND",o}).register=function(e,t){s[e]=t},e.parcelRequire1c26=i);var a=i.register;a("7KTRf",function(e,t){i("jcBBX"),i("b8ikq")}),a("jcBBX",function(e,t){i("l8jY8"),i("fw7Hj"),i("b8ikq"),i("3tWFl"),i("hypTO"),i("2ByoK")}),a("l8jY8",function(e,t){i("hypTO")}),a("hypTO",function(e,t){var s=i("7WQrb"),a=i("5D1XK");i("RKbfs"),i("3I5Zu"),i("dLLJA");class o extends a.WebComponent{connectedCallback(){super.connectedCallback(),console.log("vertical navbar connecté"),this.onMounting(),document.addEventListener("close-navbars",this.handleCloseNavbars.bind(this)),document.addEventListener("open-navbars",this.handleOpenNavbars.bind(this))}onMounting(){let e=JSON.parse(localStorage.getItem("navigation"));!1===e.horizontal_vertical_state?this.Minimize():!0===e.horizontal_vertical_state&&this.Expand()}handleCloseNavbars(e){if(!0===this.isOpen&&(this.isOpen=!1,this.open="false"),!1===e.detail.horizontalstate&&!1===this.isOpen){let e={horizontal_vertical_state:this.isOpen};this.Minimize(),localStorage.setItem("navigation",JSON.stringify(e))}}handleOpenNavbars(e){if(!1===this.isOpen&&(this.isOpen=!0,this.open="true"),!0===e.detail.horizontalstate&&!0===this.isOpen){let e={horizontal_vertical_state:this.isOpen};this.Expand(),localStorage.setItem("navigation",JSON.stringify(e))}}Minimize(){let e=this.shadowRoot?.querySelectorAll("#sidebar")[0],t=this.shadowRoot?.querySelectorAll("a"),s=this.shadowRoot?.querySelectorAll("#switch-mode")[0],i=this.shadowRoot?.querySelectorAll(".moon-sun")[0];t.forEach(e=>{e.classList.toggle("close"),e.parentElement.classList.toggle("close")}),s.classList.toggle("close"),e.classList.toggle("close"),i.classList.toggle("close")}Expand(){let e=this.shadowRoot?.querySelectorAll("#sidebar")[0],t=this.shadowRoot?.querySelectorAll("a"),s=this.shadowRoot?.querySelectorAll("#switch-mode")[0],i=this.shadowRoot?.querySelectorAll(".moon-sun")[0];t.forEach(e=>{e.classList.remove("close")}),s.classList.remove("close"),e.classList.remove("close"),i.classList.remove("close")}attributeChangedCallback(e,t,s){"isopen"===e&&(this.open=s),super.attributeChangedCallback(e,t,s)}constructor(...e){super(...e),this.isOpen=!0,this.open=null}}(0,s.__decorate)([(0,a.state)()],o.prototype,"isOpen",void 0),(0,s.__decorate)([(0,a.attr)()],o.prototype,"open",void 0),(0,s.__decorate)([(0,a.customElement)({name:"vertical-navbar",template:(0,a.html)`${e=>(0,a.html)`
        <nav id="sidebar">
         <ul id="top-sidebar">
            <li>
               <a href="/pages/">
      ...
      `]})],o)});
//# sourceMappingURL=index.c9bbbb46.js.map
