var e=globalThis,t={},s={},i=e.parcelRequire1c26;null==i&&((i=function(e){if(e in t)return t[e].exports;if(e in s){var i=s[e];delete s[e];var a={id:e,exports:{}};return t[e]=a,i.call(a.exports,a,a.exports),a.exports}var o=Error("Cannot find module '"+e+"'");throw o.code="MODULE_NOT_FOUND",o}).register=function(e,t){s[e]=t},e.parcelRequire1c26=i);var a=i.register;a("7KTRf",function(e,t){i("jcBBX"),i("b8ikq")}),a("jcBBX",function(e,t){i("l8jY8"),i("fw7Hj"),i("b8ikq"),i("3tWFl"),i("hypTO"),i("2ByoK")}),a("l8jY8",function(e,t){i("hypTO")}),a("hypTO",function(e,t){var s=i("7WQrb"),a=i("5D1XK");i("RKbfs"),i("3I5Zu"),i("dLLJA");class o extends a.WebComponent{connectedCallback(){super.connectedCallback(),console.log("vertical navbar connecté"),this.onMounting(),document.addEventListener("close-navbars",this.handleCloseNavbars.bind(this)),document.addEventListener("open-navbars",this.handleOpenNavbars.bind(this)),document.addEventListener("dark-mode",this.handleMode.bind(this)),document.addEventListener("light-mode",this.handleMode.bind(this))}onMounting(){let e=JSON.parse(localStorage.getItem("navigation"));!1===e.horizontal_vertical_state?this.Minimize():!0===e.horizontal_vertical_state&&this.Expand()}handleMode(e){let t=JSON.parse(localStorage.getItem("navigation"))||{};!0===e.detail.dark_mode&&!1===this.isDark?(this.isDark=!0,this.darkMode(),t.dark_mode=this.isDark,localStorage.setItem("navigation",JSON.stringify(t))):!1===e.detail.dark_mode&&!0===this.isDark&&(this.isDark=!1,this.lightMode(),t.dark_mode=this.isDark,localStorage.setItem("navigation",JSON.stringify(t)))}darkMode(){let e=this.shadowRoot?.querySelector("#sidebar"),t=this.shadowRoot?.querySelectorAll("a"),s=this.shadowRoot?.querySelectorAll("svg");e&&e.classList.remove("light"),t.forEach(e=>{e.classList.remove("light"),e.parentElement&&e.parentElement.classList.remove("light")}),s.forEach(e=>e.classList.remove("light"))}lightMode(){let e=this.shadowRoot?.querySelector("#sidebar"),t=this.shadowRoot?.querySelectorAll("a"),s=this.shadowRoot?.querySelectorAll("svg");e&&e.classList.toggle("light"),t.forEach(e=>{e.classList.toggle("light"),e.parentElement&&e.parentElement.classList.toggle("light")}),s.forEach(e=>e.classList.toggle("light"))}handleCloseNavbars(e){let t=JSON.parse(localStorage.getItem("navigation"))||{};!0===this.isOpen&&(this.isOpen=!1,this.open="false"),!1===e.detail.horizontalstate&&!1===this.isOpen&&(t.horizontal_vertical_state=this.isOpen,localStorage.setItem("navigation",JSON.stringify(t)),this.Minimize())}handleOpenNavbars(e){let t=JSON.parse(localStorage.getItem("navigation"))||{};!1===this.isOpen&&(this.isOpen=!0,this.open="true"),!0===e.detail.horizontalstate&&!0===this.isOpen&&(t.horizontal_vertical_state=this.isOpen,localStorage.setItem("navigation",JSON.stringify(t)),this.Expand())}Minimize(){let e=this.shadowRoot?.querySelectorAll("#sidebar")[0];(this.shadowRoot?.querySelectorAll("a")).forEach(e=>{e.classList.toggle("close"),e.parentElement.classList.toggle("close")}),e.classList.toggle("close")}Expand(){let e=this.shadowRoot?.querySelectorAll("#sidebar")[0];(this.shadowRoot?.querySelectorAll("a")).forEach(e=>{e.classList.remove("close"),e.parentElement.classList.remove("close")}),e.classList.remove("close")}attributeChangedCallback(e,t,s){"isopen"===e&&(this.open=s),super.attributeChangedCallback(e,t,s)}switchMode(){let e=this.shadowRoot?.querySelectorAll("#sidebar")[0];(this.shadowRoot?.querySelectorAll("a")).forEach(e=>{e.classList.remove("close"),e.parentElement.classList.remove("close")}),e.classList.remove("close")}constructor(...e){super(...e),this.isOpen=!0,this.isDark=!0,this.open=null,this.dark=null}}(0,s.__decorate)([(0,a.state)()],o.prototype,"isOpen",void 0),(0,s.__decorate)([(0,a.state)()],o.prototype,"isDark",void 0),(0,s.__decorate)([(0,a.attr)()],o.prototype,"open",void 0),(0,s.__decorate)([(0,a.attr)()],o.prototype,"dark",void 0),(0,s.__decorate)([(0,a.customElement)({name:"vertical-navbar",template:(0,a.html)`${e=>(0,a.html)`
        <nav id="sidebar">
         <ul id="top-sidebar">
            <li>
               <a href="/pages/">
      ...
      `]})],o)}),a("b8ikq",function(e,t){i("3tWFl")}),a("3tWFl",function(e,t){var s=i("7WQrb"),a=i("5D1XK");i("RKbfs"),i("3I5Zu"),i("dLLJA"),i("jcBBX");class o extends a.WebComponent{connectedCallback(){super.connectedCallback(),console.log("main-application connecté"),this.onMounting(),document.addEventListener("close-navbars",this.handleRemoveExpanseContent.bind(this)),document.addEventListener("open-navbars",this.handleExpanseContent.bind(this))}onMounting(){let e=JSON.parse(localStorage.getItem("navigation"));!1===e.horizontal_vertical_state?this.Expand():!0===e.horizontal_vertical_state&&this.Minimize()}handleRemoveExpanseContent(e){e.detail?.horizontalstate===!1&&(this.isExpanse=!1,this.expanse="false",this.Expand())}handleExpanseContent(e){e.detail?.horizontalstate===!0&&(this.isExpanse=!0,this.expanse="true",this.Minimize())}Expand(){(this.shadowRoot?.querySelectorAll(".right-content")[0]).classList.toggle("expand")}Minimize(){(this.shadowRoot?.querySelectorAll(".right-content")[0]).classList.remove("expand")}attributeChangedCallback(e,t,s){"expanse"===e&&(this.expanse=s),super.attributeChangedCallback(e,t,s)}constructor(...e){super(...e),this.isExpanse=!0,this.expanse=null}}(0,s.__decorate)([(0,a.state)()],o.prototype,"isExpanse",void 0),(0,s.__decorate)([(0,a.attr)()],o.prototype,"expanse",void 0),(0,s.__decorate)([(0,a.customElement)({name:"main-application",template:(0,a.html)`${e=>(0,a.html)`
        <div id="application">
            <div class="header">
      ...
      `]})],o)});
//# sourceMappingURL=index.2aea5d9f.js.map
