...
},{"express":"express","cookie-parser":"cookie-parser","morgan":"morgan","cors":"cors","path":"path","../../url":"enBqX","./routes":"51LTF","@parcel/transformer-js/src/esmodule-helpers.js":"i8bdk"}],"enBqX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"51LTF":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _express = require("express");
var _expressDefault = parcelHelpers.interopDefault(_express);
...
var _utilisateursDefault = parcelHelpers.interopDefault(_utilisateurs);
var _informations = require("./informations");
var _informationsDefault = parcelHelpers.interopDefault(_informations);
const router = (0, _expressDefault.default).Router();
// Routes principales
router.use("/accueil", (0, _accueilDefault.default));
router.use("/utilisateurs", (0, _utilisateursDefault.default));
router.use("/informations", (0, _informationsDefault.default));
exports.default = router;

},{"express":"express","./accueil":"3FF6Y","./utilisateurs":"lGXtF","./informations":"8X1js","@parcel/transformer-js/src/esmodule-helpers.js":"i8bdk"}],"3FF6Y":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _express = require("express");
var _expressDefault = parcelHelpers.interopDefault(_express);
...
router.get("/", async (res, req)=>{
    req.send(200).json({
        message: "Hello from accueil"
    });
});
exports.default = router;

},{"express":"express","@parcel/transformer-js/src/esmodule-helpers.js":"i8bdk"}],"lGXtF":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _express = require("express");
var _expressDefault = parcelHelpers.interopDefault(_express);
...
router.post("/verification", async (req, res)=>{
    try {
        ...
        if (result.exists) {
            console.log("Utilisateur d\xe9j\xe0 existant:", result.user);
            res.status(409).json({
                message: "L'utilisateur existe d\xe9j\xe0."
            });
        } else {
            console.log("Aucun utilisateur trouv\xe9, inscription possible.");
            res.status(200).json({
                message: "Aucun utilisateur trouv\xe9, inscription possible."
            });
        }
    } catch (error) {
        console.error("Erreur lors de la v\xe9rification de l'utilisateur :", error);
        res.status(500).json({
            message: "Erreur serveur lors de la v\xe9rification de l'utilisateur."
        });
    }
});
...
},{"express":"express","../packages/db/client":"lxff2","@parcel/transformer-js/src/esmodule-helpers.js":"i8bdk"}],"lxff2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Client {
    ...
    IsUserExist(nom, prenom, email, date_naissance) {
        return new Promise((resolve, reject)=>{
            ...
            console.log("\xc9x\xe9cution de la requ\xeate :");
            console.log(sql, values);
            ...
            mysqlConnector.query(sql, values, (error, results)=>{
                if (error) {
                    ...
                    console.log("Utilisateur trouv\xe9 :", results);
                    resolve({
                        exists: true,
                        user: results[0]
                    }); // Utilisateur trouvé
                } else {
                    console.log("Aucun utilisateur trouv\xe9.");
                    resolve({
                        exists: false
    ...
    obtenirLeStatus() {
        return new Promise((resolve, reject)=>{
            ...
            console.log(sql);
            console.log("Ex\xe9cution de la requ\xeate pour obtenir les r\xf4les");
            mysqlConnector.query(sql, [], (error, results)=>{
                if (error) {
                    console.error("Erreur lors de la r\xe9cup\xe9ration des r\xf4les : " + error.message);
                    reject(error);
                } else {
                    console.log("Status r\xe9cup\xe9r\xe9s avec succ\xe8s :", results);
        ...
        return new Promise((resolve, reject)=>{
            ...
            mysqlConnector.query(sql, [], (error, results)=>{
                if (error) {
                    ...
                    console.log("R\xf4les r\xe9cup\xe9r\xe9s avec succ\xe8s :", results);
                    resolve(results); // retourne les rôles obtenus
                }
                // Fermez la connexion ici après avoir traité les résultats
                mysqlConnector.close();
    ...
    obtenirLesGenres() {
        return new Promise((resolve, reject)=>{
            ...
            const sql = `
                SELECT * FROM genres`;
            console.log("Ex\xe9cution de la requ\xeate pour obtenir les genres");
            mysqlConnector.query(sql, [], (error, results)=>{
                if (error) {
                    console.error("Erreur lors de la r\xe9cup\xe9ration des r\xf4les : " + error.message);
                    reject(error);
...
},{"mysql":"mysql","@parcel/transformer-js/src/esmodule-helpers.js":"i8bdk"}],"8X1js":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _express = require("express");
var _expressDefault = parcelHelpers.interopDefault(_express);
...
router.get("/abonnement", async (req, res)=>{
    const client = new (0, _client.Client)();
    client.obtenirLesPlansTarifaires().then((roles)=>{
        res.status(200).json({
            roles
        });
    }).catch((error)=>{
        console.error("Erreur lors de la r\xe9cup\xe9ration des plans tarifaires :", error);
        res.status(500).json({
            message: "Erreur lors de la r\xe9cup\xe9ration des plans tarifaires",
            error: error.message
        });
    });
});
router.get("/genres", async (req, res)=>{
    const client = new (0, _client.Client)();
    client.obtenirLesGenres().then((roles)=>{
        res.status(200).json({
            roles
        });
    }).catch((error)=>{
        console.error("Erreur lors de la r\xe9cup\xe9ration des genres :", error);
        res.status(500).json({
            message: "Erreur lors de la r\xe9cup\xe9ration des genres",
            error: error.message
        });
    });
});
router.get("/status", async (req, res)=>{
    const client = new (0, _client.Client)();
    client.obtenirLeStatus().then((roles)=>{
        res.status(200).json({
            roles
        });
    }).catch((error)=>{
        console.error("Erreur lors de la r\xe9cup\xe9ration des status :", error);
        res.status(500).json({
            message: "Erreur lors de la r\xe9cup\xe9ration des status",
            error: error.message
        });
    });
});
...
},{"express":"express","../packages/db/client":"lxff2","@parcel/transformer-js/src/esmodule-helpers.js":"i8bdk"}]},["2yv2t","lLvi7"], "lLvi7", "parcelRequire1c26")
